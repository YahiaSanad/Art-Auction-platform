package com.artauction.auctionservice.Aops.Aspect;

import com.artauction.auctionservice.Aops.Roles.RequiresRole;
import com.artauction.auctionservice.Security.JwtRoleExtractor;
...
public class RoleAuthorizationAspect {
    ...
    @Around("@annotation(com.artauction.auctionservice.Aops.Roles.RequiresRole) || " +
            "@within(com.artauction.auctionservice.Aops.Roles.RequiresRole)")
    public Object checkRole(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        RequiresRole requiresRole = method.isAnnotationPresent(RequiresRole.class)
                ? method.getAnnotation(RequiresRole.class)
                : joinPoint.getTarget().getClass().getAnnotation(RequiresRole.class);
